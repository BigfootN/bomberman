...
#include "ai_timer.h"
#include "../07_network/tcpserver.h"
...
void deletePlayers(state_t* state)
{
    ...
    while (player != NULL)
    {
        send_request_uniq_player(state, player->socked_player, 3, 5);
        SDL_Delay(100);
