...
t_control *init_control()
{
 ...
 //   control->network->ip_serveur = my_strdup("193.168.1.10");
...
//    control->receive_map->state_player->win = 0;
    ...
    control->receive_map->stat_user[0] = 0;
    control->receive_map->stat_user[1] = 0;
    control->receive_map->stat_user[2] = 0;
    control->receive_map->stat_user[3] = 0;
    control->receive_map->stat_user[4] = 0;
    control->receive_map->stat_user[5] = 0;
    control->receive_map->stat_user[6] = 0;
...
//        return NULL;
    ...
    etat->winusers[2] = 0;
    etat->winusers[3] = 0;
    etat->msg->stat_user[0] = 0;
    etat->msg->stat_user[1] = 0;
    etat->msg->stat_user[2] = 0;
    etat->msg->stat_user[3] = 0;
    etat->msg->stat_user[4] = 0;
    etat->msg->stat_user[5] = 0;
    etat->msg->stat_user[6] = 0;
    etat->msg->stat_user[7] = 0;
